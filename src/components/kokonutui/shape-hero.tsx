...
export default function ShapeHero({
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-white dark:bg-[#030303]">
      <div className="absolute inset-0 bg-linear-to-br from-blue-500/[0.03] via-transparent to-zinc-500/[0.02] blur-3xl dark:from-blue-500/[0.06] dark:via-transparent dark:to-zinc-500/[0.04]" />
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <ElegantShape
          ...
          delay={0.3}
          gradient="from-blue-500/[0.2] dark:from-blue-500/[0.3]"
          height={500}
          rotate={-8}
          width={300}
        />
        ...
        <ElegantShape
          ...
          delay={0.5}
          gradient="from-zinc-400/[0.2] dark:from-zinc-400/[0.15]"
          height={200}
          rotate={15}
          width={600}
        />
        ...
        <ElegantShape
          ...
          delay={0.4}
          gradient="from-blue-400/[0.15] dark:from-blue-400/[0.2]"
          height={300}
          rotate={24}
          width={300}
        />
        ...
        <ElegantShape
          ...
          delay={0.6}
          gradient="from-zinc-500/[0.15] dark:from-zinc-500/[0.2]"
          height={100}
          rotate={-20}
          width={250}
        />
        ...
        <ElegantShape
          ...
          delay={0.2}
          gradient="from-blue-400/[0.18] dark:from-blue-400/[0.25]"
          height={200}
          rotate={-25}
          width={200}
        />
        ...
        <ElegantShape
          ...
          delay={0.8}
          gradient="from-zinc-400/[0.15] dark:from-zinc-400/[0.18]"
          height={80}
          rotate={45}
          width={150}
        />
        ...
        <ElegantShape
          ...
          delay={0.9}
          gradient="from-blue-500/[0.15] dark:from-blue-500/[0.22]"
          height={120}
          rotate={-12}
          width={450}
        />
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            <h1 className="mb-6 font-bold text-4xl tracking-tight sm:text-6xl md:mb-8 md:text-8xl">
              ...
              <span
                className={cn(
                  "italic leading-[1.15] pb-1 bg-linear-to-r from-indigo-300 via-black/90 to-rose-300 bg-clip-text text-transparent dark:from-indigo-300 dark:via-white/90 dark:to-rose-300"
                )}
              >
                {title2}
              </span>
